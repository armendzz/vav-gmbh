  ...
  <div class="container">
    <div class="mt-3">
      ...
      <p>
        ...
        VAV Armierungen GmbH. Die VAV Armierungen GmbH ist als verantwortliche
        Stelle unter den nachfolgend genannten Kontaktdaten für Sie erreichbar:
      </p>
      <p>
        <strong>VAV Armierungen GmbH</strong><br />
      ...
      <p>
        ...
        Nutzung Ihrer Daten durch die VAV Armierungen GmbH nach Massgabe dieser
      ...
      <p>
        Diese Webseite wird von VAV Armierungen GmbH, betrieben. Die auf dieser
      ...
      <p>
        ...
        Webseite verwendet werden, bei der VAV Armierungen GmbH. Deren
        Verwendung ohne die ausdrückliche vorgängige Zustimmung von VAV
        Armierungen GmbH ist untersagt. Auch das automatisierte vollständige
        oder teilweise Abrufen oder Darstellen von Inhalten dieser Webseite
        mittels technischer Hilfsmittel (wie Webcrawler-/Spider-Programme,
        Metasuchmaschinen, Framing) ist untersagt.
      </p>
      <h4>3. Zweck der Datenschutzerklärung</h4>
      <p>
        3.1. VAV Armierungen GmbH ist Betreiberin der Plattform www.vav-gmbh.ch,
        über die sie für Kunden Web- und Online-Dienstleistungen erbringt.
      </p>
      <p>
        Der Datenschutz ist VAV Armierungen GmbH wichtig. VAV Armierungen GmbH
        hält sich an die geltenden datenschutzrechtlichen Vorgaben und
        Regelungen.
      </p>
      <p>
        3.2. Diese Datenschutzerklärung zeigt den Umgang von VAV Armierungen
        GmbH mit Personendaten auf und legt insbesondere dar, welche
        Personendaten von VAV Armierungen GmbH bearbeitet werden und zu welchen
        Zwecken die Bearbeitung dieser Daten erfolgt. Sie beschreibt zudem, wie
        gesammelte Personendaten überprüft, korrigiert oder gelöscht werden
        können.
      </p>
      <p>
      ...
      <p>
        ...
        Allgemeinen Geschäftsbedingungen von VAV Armierungen GmbH.
      </p>
      <h4>4. Personendaten</h4>
      <p>
        VAV Armierungen GmbH respektiert die Privatsphäre ihrer Kunden und
        sammelt nur Personendaten (wie Name, Adresse, E-Mail-Adresse), wenn
        diese:
      </p>
      <p>
        vom Kunden freiwillig zur Verfügung gestellt (insb.: Vorname, Nachname,
        Adresse, Mobile-Nummer, Email-Adresse oder MwSt.-Nummer);<br />
        oder durch Cookies automatisch erhoben werden.
      </p>
      <h4>5. Verwendung von Personendaten</h4>
      <p>
        5.1. Vom Kunden an VAV Armierungen GmbH übermittelte Daten dürfen von
        VAV Armierungen GmbH wie folgt verwendet werden:
      </p>
      <p>
        ...
        besser zu verstehen und die Dienste von VAV Armierungen GmbH zu
        verbessern;<br />
        Um Geschäfte mit dem Kunden zu tätigen. Zu diesem Zweck darf VAV
        Armierungen GmbH die ihr vom Kunden übermittelten Daten auch an
        Vertriebs- und Kooperationspartner von VAV Armierungen GmbH im In- und
        Ausland senden. Weitere Personen erhalten von den Personendaten keine
        Kenntnis.
      </p>
      <p>
      ...
      <p>
        VAV Armierungen GmbH wird Personendaten keinesfalls an Dritte verkaufen
        oder auf andere Weise vermarkten.
      </p>
      <h4>6. Datenschutz</h4>
      <p>
      ...
      <p>
        Auf verschiedenen Seiten verwenden wir (VAV Armierungen GmbH) Cookies,
        um den Besuch unserer Webseite attraktiver zu gestalten und die Nutzung
        ...
        wieder von Ihrer Festplatte gelöscht (temporäre Cookies).
      </p>
      <p>
      ...
      <p>
        8.1. VAV Armierungen GmbH sieht Sicherheitsmassnahmen vor, um Verlust,
      ...
      <p>
        ...
        sicher sind. Sobald VAV Armierungen GmbH die übertragenen Informationen
        erhalten hat, sichert sie diese in angemessener Weise in ihren Systemen.
      </p>
      <h4>9. Anpassung der Datenschutzerklärung</h4>
      <p>
        VAV Armierungen GmbH behält sich das Recht vor, diese
        Datenschutzerklärung jederzeit im Rahmen der gesetzlichen Vorgaben
        anzupassen.
      </p>
      ...
      <p>
        ...
        abrufbaren Informationen entstehen, wird ausgeschlossen.
      </p>
      <p>
        Insbesondere wird keine Haftung für die Aktualität, Vollständigkeit und
